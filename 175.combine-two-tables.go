...
// select table person(p) and address(a) 
select p.firstName,p.lastName,a.city,a.state
// from person table and address table
from Person p  
// left join address table on personId, make the personId from both column link together
left join Address a
